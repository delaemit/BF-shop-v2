...
// Home > My Account
Breadcrumbs::for('account', function (BreadcrumbTrail $trail): void {
    $trail->parent('home');
...
Breadcrumbs::for('addresses', function (BreadcrumbTrail $trail): void {
    $trail->parent('account');
    $trail->push(trans('shop::app.layouts.address'), route('shop.customers.account.addresses.index'));
});

// Home > My Account > Address > Create
Breadcrumbs::for('addresses.create', function (BreadcrumbTrail $trail): void {
...
Breadcrumbs::for('addresses.edit', function (BreadcrumbTrail $trail, $entity): void {
    $trail->parent('addresses');
...
Breadcrumbs::for('orders.view', function (BreadcrumbTrail $trail, $entity): void {
    $trail->parent('orders');
...
Breadcrumbs::for('downloadable-products', function (BreadcrumbTrail $trail): void {
    $trail->parent('account');
...
Breadcrumbs::for('reviews', function (BreadcrumbTrail $trail): void {
    $trail->parent('account');
...
// Home > Comapre
Breadcrumbs::for('compare', function (BreadcrumbTrail $trail): void {
    $trail->parent('home');
    $trail->push(trans('shop::app.compare.product-compare'), route('shop.compare.index'));
});

// Home > Product
Breadcrumbs::for('product', function (BreadcrumbTrail $trail, $entity): void {
    $trail->parent('home');
