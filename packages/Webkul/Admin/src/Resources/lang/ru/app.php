            ...
            'customer' => [
                ...
                'address' => [
                    ...
                    'information' => [
                        ...
                        'title' => 'Информация',
                        'title-info' => "«Строки в адресе улицы» относятся к отдельным сегментам адреса, часто разделенным запятыми, предоставляющим информацию о местоположении, такую \u{200b}\u{200b}как номер дома, улица, город и т. д.",
                    ],
                ],
